l = {
    Notice: {
        strong: {
            ...
            EN: '<b style="color:#ffea00">MopiMopi<br>Experience the Incredible Customizing!</b><br><br><b>Chrome or Safari</b> apps are recommended for mobile environment.<br>PC Users : <b>OverlayProc ❯ MUST Check "AppRegion"</b> to limit the draggable area.<br><br><font style="color:cyan">If you are using FFXIV_ACT_Plugin version 2.0.2.3 or later,<br>ACT → Plugins → FFXIV Settings Tab → <b>Check Disable Combine Pets with Owner</b>.<br>'
        },
        tip: {
            KR: '[OFFICIAL] MopiMopi ver.20220604 / 해루@모그리',
            EN: '[OFFICIAL] MopiMopi ver.20230921 / Gidedin 2'
        },
        update: {
